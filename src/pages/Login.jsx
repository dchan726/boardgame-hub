...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-stone-200 bg-[url('https://www.transparenttextures.com/patterns/cream-paper.png')]">      <div className="max-w-md w-full bg-white p-8 rounded-[2rem] shadow-2xl border-2 border-stone-200">
